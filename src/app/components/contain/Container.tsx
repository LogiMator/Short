...
export function Container() {
    ...
    <main className="bg-[#020016] text-white justify-center flex relative">
        <div className="w-[70%] sm:w-full ">
            <NavBar />
                ...
                <Image src={"/images/caqui.png"} className="hidden lg:block" width={480} height={520} alt="Modelo" />
                    <div className="w-[420px] mx-4 my-10">
        ...
        <div className="hidden md:w-[30%]  bg-[#FF0042] md:flex md:flex-col md:justify-center md:items-center">
            <Image src={"/images/camisa.png"} className="hidden sm:block" width={220} height={320} alt="Camisa" />
